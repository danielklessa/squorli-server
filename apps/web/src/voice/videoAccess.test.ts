...
const member = (userId: string, roleIds: string[], isOwner = false) =>
  ({ userId, displayName: userId, publicKey: "k", roleIds, joinedAt: "2026-09-17T00:00:00.000Z", online: true, afk: false, game: null, streamBlocked: false, handle: null, avatarUrl: null, isOwner });
