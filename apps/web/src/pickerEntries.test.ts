...
const member = (userId: string, displayName: string, handle: string | null = null): Member => ({
  userId, displayName, publicKey: "k".repeat(64), roleIds: [], joinedAt: "2026-09-23T00:00:00.000Z", online: true, afk: false, game: null, streamBlocked: false, handle, avatarUrl: null, localHandle: null, isOwner: false,
});
