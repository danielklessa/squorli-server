...
export type DesktopConfig = { appearance?: unknown; window?: unknown; closeToTray?: unknown; autostartBackground?: unknown; /** Version handed to the installer at a start (splashPage.ts `mayInstallAtStart`). */ updateAttempt?: unknown; /** The key of control links (controlArgs.ts), made once. */ controlKey?: unknown };
